"""5-shot few-shot segmentation configuration for iSAID.

Addresses Reviewer Q3: 5-shot evaluation with multi-seed support.
"""
from adatile.config import Config
from configs.default import get_default_config


def get_5shot_config(seed: int = 42) -> Config:
    cfg = get_default_config()

    cfg.experiment_name = "adatile_5shot_seed{}".format(seed)
    cfg.output_dir = "output/fewshot/5shot/seed{}".format(seed)
    ...
    cfg.data.n_shot = 5
    cfg.data.n_way = 3
    cfg.data.fewshot_split = "datasets/iSAID/fewshot_splits/5shot/split0.json"
    ...
    cfg.prototype.num_prototypes_per_class = 5  # one per support example
    ...
    cfg.train.checkpoint_dir = "checkpoints/fewshot/5shot/seed{}".format(seed)
