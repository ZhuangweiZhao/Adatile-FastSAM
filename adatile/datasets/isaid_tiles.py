...
用法 | Usage::
    ds = FastISAIDTileDataset(root_dir="data/iSAID_tiles", split="train", dense_labels=True)
...
class FastISAIDTileDataset(Dataset):
    ...
    split : str
        "train" / "val" / "test".
    dense_labels : bool
        True = mask 为 [H,W] int64 密集类别标签 (0=bg, 1-15).
        False = mask 为 [H,W] uint8 0/255 二值实例掩码.
    """

    def __init__(self, root_dir: str = "data/iSAID_tiles",
                 split: str = "train", dense_labels: bool = True):
        ...
        logger.log_info(
            ...
            f"dense_labels={dense_labels}, avg ~20ms/sample",
        )
