...
# 类别 ID 映射 | Category ID mapping
ACTUAL_TO_CODE_ID = {
    1: 4, 2: 2, 3: 1, 4: 3, 5: 5, 6: 10, 7: 6, 8: 9,
    9: 7, 10: 8, 11: 11, 12: 13, 13: 12, 14: 15, 15: 14,
}

# iSAID 类别名 | Class names (code_id → name)
CLASS_NAMES = {
    1: "ship", 2: "ST", 3: "BD", 4: "TC", 5: "BC",
    6: "GTF", 7: "harbor", 8: "bridge", 9: "LV",
    10: "SP", 11: "RA", 12: "HC", 13: "SV", 14: "SP", 15: "ground",
}
