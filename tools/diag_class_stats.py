...
ISAID_NAMES = {
    ...
    7: "harbor", 8: "bridge", 9: "large_vehicle",
    10: "small_vehicle", 11: "helicopter", 12: "swimming_pool",
    13: "roundabout", 14: "soccer_ball_field", 15: "plane",
}
...
def analyze_coco(args):
    ...
    for ann in coco["annotations"]:
        ...
        code_id = ACTUAL_TO_CODE_ID.get(raw_id, 0)
        if code_id <= 0:
            continue
